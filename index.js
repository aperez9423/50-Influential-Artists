...
function lotsOfArt(array){
  ...
  for (let i=0; i < array.length; i++) {
    let numberOfPaintings = array [i];
    if (numberOfPaintings.paintings>100) {
      newArray.push (numberOfPaintings.name);
    }
  }
  return newArray;
  }
...
addArtist ({id:20, name:"Angelica Perez", years:"1993 -2020", genre:"Web Design", nationality:"American", bio: "Angelica Perez is a twenty-five year old American. She enjoys learning languages and solving puzzles."});
